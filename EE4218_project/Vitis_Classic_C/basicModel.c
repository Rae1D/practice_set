/*
Using the given csv files from the github
*/
...
int main()
{
    int input[64][7]; // one test input first 
    int output[64][2];
    int sig_output[64][2];
    int pred[64];

    // int (*input)[7] = malloc(1 * 7 * sizeof(int));
    // int (*output)[2] = malloc(1 * 2 * sizeof(int));
    // int (*sig_output)[2] = malloc(1 * 2 * sizeof(int));
    int bias_hidden[2] = {26,6};
    // int weight_hidden[2][7] = {
    //     {25,31,29,22,1,11,26},
    //     {18,6,26,1,28,8,45}
    // };

    int weight_hidden[7][2] = { // the weights for the 2 hidden neurons 
        {25,18},
        {31,6},
        {29,26},
        {22,1},
    ...
    int bias_output[1] = {80};
    int weight_output[2][1] = { // the weights for the 2 hidden neurons 
        {50},
        {200}
    };
    ...
    // sigmoid(test_in, sig_output);


    hidden_layer(test_in, output, weight_hidden, bias_hidden);
